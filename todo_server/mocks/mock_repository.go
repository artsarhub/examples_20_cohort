...
// Source: yp-examples/todo_server/internal/handler (interfaces: Repository)
//
// Generated by this command:
//
//	mockgen -package mocks -destination=../../mocks/mock_repository.go yp-examples/todo_server/internal/handler Repository
//
